...
4. Tests: 137 (fund ~75, App ~39, format 14, references 3, StructuredData 6, ChartCard 2, ChartSlot 2, index-html 1, analytics 1, about 1, llms 5). TDD is mandatory for any new feature: red → green → refactor.
